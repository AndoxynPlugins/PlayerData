...
public class ListPlayersFirstJoinCommandHandler implements SubCommandHandler {
    ...
    public ListPlayersFirstJoinCommandHandler(PlayerDataBukkit playerDataMain) {
    ...
    public void runCommand(CommandSender sender, Command baseCommand, String baseCommandLabel, SubCommand subCommand, String subCommandLabel, String[] subCommandArgs) {
        ...
        List<PlayerDataImpl> pDataList = playerDataMain.getPDataHandler().getAllPDatasFirstJoin();
        ...
        for (int i = (pageNumberReal * 6); i < ((pageNumberReal + 1) * 6) && i < pDataList.size(); i++) {
            ...
            messagesToSend.add(ColorList.NAME + current.getUsername() + ColorList.REG + " was first seen " + ColorList.DATA + StaticHelper.getFormattedDate(System.currentTimeMillis() - current.getFirstLogIn().getDate()) + ColorList.REG + " ago.");
        }
